...
#define MSG_AUCTIONITEMSTATUS_0 "For sale"
#define MSG_AUCTIONITEMSTATUS_1 "Sold"
#define MSG_AUCTIONITEMSTATUS_2 "Outdated"
#define MSG_AUCTION_LOADING "Loading Items.. Please wait."
...
#define MSG_NOTIFY_NAMECHANGE	"You successfully changed your character name."
...
#define MSG_NOTIFY_ANGEL_MAJESTIC		"You need additional Slayer Points."
...
#define	ON_KEY_UP31	"Ability that holds an enemy in place: Can be used after %d sec"
...
#define	ON_KEY_UP39	"Ability that holds an enemy in place: Can be used after %d minutes"
...
#define	NOTIFY_MSG_HANDLER30	"Special ability has run out! Will be available in 1 hour."
...
#define	NOTIFY_MSG_HANDLER74	"You can't recall within 10 seconds of taking damage or 5 seconds of movement."
...
#define	NOTIFY_MSG_HANDLER80	"Not enough Contribution."

#define	NOTIFY_MSG_HANDLER81	"You cast a powerfull incantation, you can't use it again before %d minutes."
#define	NOTIFY_MSG_HANDLER82	"You cast a powerfull incantation, you can't use it again before %d seconds."
#define	NOTIFY_MSG_HANDLER83	"You can resurrect a player!"
#define	NOTIFY_MSG_HANDLER84	"%s was banned from the party."
...
#define	NPC_NAME_ORCMAGE			"Orc-Mage"
...
#define	NPC_NAME_AUCTIONHOUSE_KEEPER	"Auction House Keeper"
...
#define	DRAW_OBJECT_NAME59B	"Elite"
...
#define	BCHECK_LOCAL_CHAT_COMMAND24	"Trees are now shown as large."
#define	BCHECK_LOCAL_CHAT_COMMAND25	"Trees are now shown as small."
#define	BCHECK_LOCAL_CHAT_COMMAND26	"Ping alert sounds are enabled."
#define	BCHECK_LOCAL_CHAT_COMMAND27	"Ping alert sounds are disabled."
#define	BCHECK_LOCAL_CHAT_COMMAND28	"Top notification bar enabled."
#define	BCHECK_LOCAL_CHAT_COMMAND29	"Top notification bar disabled."
...
#define	GET_ITEM_NAME14	"+%d Critical Damage"
#define	GET_ITEM_NAME15	"+%d Poison Damage"
#define	GET_ITEM_NAME16	"Attack Speed -1"
#define	GET_ITEM_NAME17	"%d%% Light"
#define	GET_ITEM_NAME18	"Damage added"
#define	GET_ITEM_NAME19	"+%d%% Endurance"
#define	GET_ITEM_NAME20	"Extra Damage added"
#define	GET_ITEM_NAME21	"+%d%% Magic Casting Chance"
#define	GET_ITEM_NAME22	"Replace %d%% Damage to MP"
#define	GET_ITEM_NAME23	"+%d%% Critical Recharge"
#define	GET_ITEM_NAME24	"+%d%% Poison Resistance"
#define	GET_ITEM_NAME25	"+%d True Hit Ratio"
#define	GET_ITEM_NAME26	"+%d Defense Ratio"
#define	GET_ITEM_NAME27	"+%d%% HP Recovery"
#define	GET_ITEM_NAME28	"+%d%% SP Recovery"
#define	GET_ITEM_NAME29	"+%d%% MP Recovery"
#define	GET_ITEM_NAME30	"+%d%% Magic Resistance"
#define	GET_ITEM_NAME31	"+%d%% Global Physical Absorption"
#define	GET_ITEM_NAME32	"+%d%% Magic Absorption"
#define	GET_ITEM_NAME33	"+%d Combo Attack Damage"
#define	GET_ITEM_NAME34	"+%d%% Experience"
#define	GET_ITEM_NAME35	"+%d%% Gold"
...
#define	GET_ITEM_NAME39	"+%d Endurance"
#define	GET_ITEM_NAME40	"+%d%% Life Leech"
#define	GET_ITEM_NAME41	"+%d%% Contribution"
#define	GET_ITEM_NAME42	"Damage: %d~%d (S-M) %d~%d (L)"
#define	GET_ITEM_NAME43	"Defense Ratio: %d (%d%% PA)"
#define	GET_ITEM_NAME44	"+%d%% Mana Save"
#define	GET_ITEM_NAME45	"+%d Physical Damage"
#define	GET_ITEM_NAME46	"+%d Magic Damage"
#define	GET_ITEM_NAME47	"+%d True Damage"
#define	GET_ITEM_NAME48	"+%d%% Earth Magic Absorption"
#define	GET_ITEM_NAME49	"+%d%% Air Magic Absorption"
#define	GET_ITEM_NAME50	"+%d%% Fire Magic Absorption"
#define	GET_ITEM_NAME51	"+%d%% Ice Magic Absorption"
#define	GET_ITEM_NAME52	"+%d Physical Hit Ratio"
#define	GET_ITEM_NAME53	"+%d%% Magic Damage"
#define	GET_ITEM_NAME54	"%d%% Physical Absorption [HEAD]"
#define	GET_ITEM_NAME55	"%d%% Physical Absorption [CHEST]"
#define	GET_ITEM_NAME56	"%d%% Physical Absorption [ARMS]"
#define	GET_ITEM_NAME57	"%d%% Physical Absorption [LEGS]"
#define	GET_ITEM_NAME58	"%d%% Physical Absorption [SHIELD]"
#define	GET_ITEM_NAME59	"+%d Magic Hit Ratio"
#define	GET_ITEM_NAME60	"+%d Defense Ratio"

#define GET_ITEM_SPECIALITEM "Ability:"
#define GET_ITEM_SPECIAL1 "%s %d%% chance to drop nothing on death"
#define GET_ITEM_SPECIAL2 "%s +%d Bonus Damage Against NPC's"
#define GET_ITEM_SPECIAL3 "%s -%d Damage Reduced By NPC's"
#define GET_ITEM_SPECIAL4 "%s %d%% Global Physical Absorption"
#define GET_ITEM_SPECIAL5 "%s %d%% Physical Absorption Against NPC's (Chest)"
#define GET_ITEM_SPECIAL6 "%s Reduces Maximum Health By %d%%"

#define	GET_ITEM_SPECIAL7 "%s Each Hit Decreases an Enemy's HP by 50%% (Activation)"
#define	GET_ITEM_SPECIAL8 "%s Each Hit Freezes an Enemy (Activation)"
#define	GET_ITEM_SPECIAL9 "%s Each Hit Holds an Enemy In Place (Activation)"
#define	GET_ITEM_SPECIAL10 "%s Each Hit Instantly Kills An Enemy (Activation)"
#define	GET_ITEM_SPECIAL11 "%s Each Hit Gains Life Equal To Damage Done (Activation)"
#define	GET_ITEM_SPECIAL12 "%s Exhausts an Enemy's Weapon When Hit (Activation)"
#define	GET_ITEM_SPECIAL13 "%s Protection From Physical Attacks (Activation)"
#define	GET_ITEM_SPECIAL14 "%s Untouchable From All Attacks (Activation)"
#define	GET_ITEM_SPECIAL15 "%s Resurrects a Friendly Player (Activation)"

#define	GET_ITEM_SPECIAL16 "%s +1 Damage Per 100 EK's Less Than Target (+7 Max)"
#define	GET_ITEM_SPECIAL17 "%s +2 Damage Dealt Per Nearby Enemy (+10 Max)"
#define	GET_ITEM_SPECIAL18 "%s -2 Damage Received Per Nearby Enemy (-10 Max)"
#define	GET_ITEM_SPECIAL19 "%s +30%% Increased Magic Damage"

//#define	LNG_DAMAGE		"Damage"
//#define	LNG_TRUEDAMAGE	"True Damage"
...
#define	UPDATE_SCREEN_ONGAME6	"You can not sell more than 50 items at the same time"
...
#define	DRAW_DIALOGBOX_BANK3	"Drop an item to the bank window to"
#define	DRAW_DIALOGBOX_BANK4	"deposit it. Click an item to withdraw it."
...
#define	DRAW_DIALOGBOX_CHARACTER10	"Upgrade (%d)"
...
#define	DRAW_DIALOGBOX_LEVELUP_SETTING14			"You can change 3 stat points"
#define	DRAW_DIALOGBOX_LEVELUP_SETTING15			"for each Contribution Point."
#define	DRAW_DIALOGBOX_LEVELUP_SETTING16			"* Contribution Points Left"
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU8	"Trade EK's For Hero items."
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU44	"Hero's Battle-Mage Cap Tier 1 (EK 100 - Contrib 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU45	"Hero's Battle-Mage Armor Tier 1 (EK 300 - Contrib 30)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU46	"Here are the available Tier 1 Hero items :"
#define	DRAW_DIALOGBOX_CITYHALL_MENU47	"Hero's Cape (EK 300)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU48	"Hero's Helm Tier 1 (EK 150 - Contrib 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU49	"Hero's Cap Tier 1 (EK 100 - Contrib 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU50	"Hero's Armor Tier 1 (EK 300 - Contrib 30)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU51	"Hero's Robe Tier 1 (EK 200 - Contrib 20)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU52	"Hero's Hauberk Tier 1 (EK 100 - Contrib 10)"
#define	DRAW_DIALOGBOX_CITYHALL_MENU53	"Hero's Leggings Tier 1 (EK 150 - Contrib 15)"
...
#define DRAW_DIALOGBOX_GUILD21	"%uM Gold, %uk Cont."
...
#define	DRAW_DIALOGBOX_NPCACTION_QUERY50 "Would you like me to repair your items"
#define	DRAW_DIALOGBOX_NPCACTION_QUERY51 "for %d gold?"
...
#define	DRAW_DIALOGBOX_PARTY31	"The character names of your party members."
#define	DRAW_DIALOGBOX_PARTY32	"Total Members: %d"
...
#define	DRAW_DIALOGBOX_PARTY46	"Failed in joining the party."
#define	DRAW_DIALOGBOX_PARTY47	"Maybe the player rejected or"
#define	DRAW_DIALOGBOX_PARTY48	"the case you offered to enemy"
#define	DRAW_DIALOGBOX_PARTY49	"or you offered to player who"
#define	DRAW_DIALOGBOX_PARTY50	"is not in peace mode or you"
#define	DRAW_DIALOGBOX_PARTY51	"are banned from the party."
#define	DRAW_DIALOGBOX_PARTY62	"Ask the party Leader to rejoin"
#define	DRAW_DIALOGBOX_PARTY63	"if you are banned."
...
#define	DRAW_DIALOGBOX_PARTY58 "Enable party member pings."
#define	DRAW_DIALOGBOX_PARTY59 "Disable party member pings."
#define	DRAW_DIALOGBOX_PARTY60 "Party leader disabled pinging."
#define	DRAW_DIALOGBOX_PARTY61 "Party leader enabled pinging."
#define	DRAW_DIALOGBOX_PARTY64	"You were banned from the party."
...
#define	DRAW_DIALOGBOX_SELL_LIST4	"up to 50 items simultaneously."
...
#define	DRAW_DIALOGBOX_AUCTIONHOUSE_LIST1   "Drop the item that you want to sell from your bag here."
...
#define	DRAW_DIALOGBOX_SELLOR_REPAIR_ITEM6	"Cost:"
#define	DRAW_DIALOGBOX_SELLOR_REPAIR_ITEM12	"%d Gold"
#define	DRAW_DIALOGBOX_SELLOR_REPAIR_ITEM13	"%d Contribution"
...
#define	DLGBOX_CLICK_MAGIC1	"Your hands must be free to cast magic."
#define	DLGBOX_CLICK_MAGIC2	"Can't cast while using a skill."
#define	DLGBOX_CLICK_MAGIC3	"Your hands must be free to use this item."
...
#define	TALKING_TO_AUCTIONHOUSE_KEEPER	"Talking to Auction House Keeper..."
...
#define	NOTIFYMSG_HUNGER1	"You are feeling hungry..."
...
//#define	NOTIFYMSG_ITEMPURCHASEDDISCOUNT	"You bought a %s with %d Gold. (%3.2f discount)"
...
#define	NOTIFYMSG_MAGICEFFECT_OFF16	"You regained you knowledge of magic."
...
#define	NOTIFYMSG_MAGICEFFECT_ON16	"Inhibition magic casted, you forgot all your knowledge of magic!"
#define	NOTIFYMSG_MAGICEFFECT_ON17	"Cancellation magic casted, you are free of all magical bounds!"
#define	NOTIFYMSG_MAGICEFFECT_ON18	"You were resurrected from the dead."
#define	NOTIFYMSG_MAGICEFFECT_ON19	"You have been frozen! Your movement decreases to 25%."
...
#define	NOTIFYMSG_MAGICSTUDY_SUCCESS2	"Corrupted Magic(%s): learned!"
#define	NOTIFYMSG_MAGICSTUDY_DEPLETED	"Magic(%s) has been forgotten!"
...
#define DRAW_DIALOGBOX_ITEMUPGRADE14 "Normal Upgrading"
#define DRAW_DIALOGBOX_ITEMUPGRADE15 "Contribution Upgrading"
#define DRAW_DIALOGBOX_ITEMUPGRADE16 "Normal Item Upgrading:"
#define DRAW_DIALOGBOX_ITEMUPGRADE17 "With upgrading weapon items,"
#define DRAW_DIALOGBOX_ITEMUPGRADE18 "Stone of Xelima is needed."
#define DRAW_DIALOGBOX_ITEMUPGRADE19 "With upgrading armor items,"
#define DRAW_DIALOGBOX_ITEMUPGRADE20 "Stone of Merien is needed."
#define DRAW_DIALOGBOX_ITEMUPGRADE21 "Merien is needed."
#define DRAW_DIALOGBOX_ITEMUPGRADE22 "Contribution Item Upgrading:"
#define DRAW_DIALOGBOX_ITEMUPGRADE23 "In order to upgrade items with contribution,"
#define DRAW_DIALOGBOX_ITEMUPGRADE24 "sufficient contribution points are required."
#define DRAW_DIALOGBOX_ITEMUPGRADE25 "Limitations are included."
#define DRAW_DIALOGBOX_ITEMUPGRADE26 "* Items cannot be upgraded with this performance."
...
#define	DRAW_DIALOGBOX_CITYHALLMENU18	"Enter a new character name"
...
#define MSG_NOTIFY_ITEMCFG "Item.cfg file contains wrong infomation."
#define MSG_NOTIFY_MAGICCFG "Magic.cfg file contains wrong infomation."
...
#define DRAW_CMDHALL19 "5 contribution points will be deducted"
...
#define DRAW_CITYHALL2 "Contribution"
...
#define DRAW_EXTENDEDSYSMENU13 "Big trees are "
#define DRAW_EXTENDEDSYSMENU14 "Ping alert sounds are "
#define DRAW_EXTENDEDSYSMENU15 "Change font style"
#define DRAW_EXTENDEDSYSMENU16 "Toggle top bar"
