...
#define	UPDATE_SCREEN_ON_VERSION_NO_MATCH2	"Ejecuta el programa \"LegionLauncher.exe\" y vuelve a intentarlo."
...
#define	DRAW_DIALOGBOX_CITYHALL_MENU11	"Legion puntos servicios."
...
#define DRAW_DIALOGBOX_GUILD21	"%uM Oro, %uk Cont."
...
#define MSG_NOTIFY_LEGIONPT1 "No tienes suficientes Legion Points!."
#define MSG_NOTIFY_LEGIONPT2 " Dirigete a http://www.helbreathlegion.net/donate.php"
...
#define LNG_STARTLAUNCHER "Ejecuta el programa \"LegionLauncher.exe\" para jugar!"
