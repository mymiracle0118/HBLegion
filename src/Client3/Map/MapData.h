...
public:
	...
	void GetOwnerStatusByObjectID(WORD wObjectID, char * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pStatus, int * pColor1, int * pColor2, char * pName);
	...
	BOOL __fastcall bSetDeadOwner(WORD wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor1, int iApprColor2, int iStatus, char * pName);
	//BOOL __fastcall bGetDeadOwner(short sX, short sY, short * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pApprColor1, int * pApprColor2, char * pFrame, char * pName, short * pItemSprite, short * pItemSpriteFrame, DWORD * pItemAttribute, char * pItemName, int * pCharIndex);
	BOOL __fastcall bGetOwner(short sX, short sY, short * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pApprColor1, int * pApprColor2, int * pStatus, char * pName, char * pAction, char * pFrame, int * pChatIndex, short * pV1, short * pV2);
	BOOL __fastcall bSetOwner(WORD wObjectID, int sX, int sY, int sType, int cDir, int iHP, int iMaxHP, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor1, int iApprColor2, int iStatus, char * pName, short sAction, short sV1, short sV2, short sV3, int iPreLoc = 0, int iFrame = 0);
	...
	BOOL bSetItem(short sX, short sY, short sIDnum, char cItemColor, DWORD dwItemAttribute, BOOL bDropEffect = TRUE);
	...
	class CTileSpr m_tile[1000][1000];//[752][752];
	class CGame * m_pGame;
