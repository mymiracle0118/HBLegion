...
void CDialogBox::SetMode(char mode)
{
	...
	case 1: ///////Character
		...
		AddButton(15, 15 + BTNSZX, 348, 348 + BTNSZY, 4);
		AddButton(98, 98 + BTNSZX, 348, 348 + BTNSZY, 5);
		break;
	...
	case 63:
		switch(mode) {
		case 0:
			AddButton((sSizeX-(74+1)*4)/2+(74+1)*0, (sSizeX-(74+1)*4)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1);
			AddButton((sSizeX-(74+1)*4)/2+(74+1)*1, (sSizeX-(74+1)*4)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2);
			AddButton((sSizeX-(74+1)*4)/2+(74+1)*2, (sSizeX-(74+1)*4)/2+(74+1)*2+74, sSizeY-45, sSizeY-45+20, 3);
			AddButton((sSizeX-(74+1)*4)/2+(74+1)*3, (sSizeX-(74+1)*4)/2+(74+1)*3+74, sSizeY-45, sSizeY-45+20, 4);
			AddButtonList(35, 180, 60, 60 + 15, 14, 5);
			break;
		case 1:
			AddButton((sSizeX-74)/2, (sSizeX-74)/2+74, sSizeY-45, sSizeY-45+20, 1);
			AddButtonList(35, 180, 60, 60 + 15, 14, 2);
			break;
		case 2:
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*0, (sSizeX-(74+1)*2)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1);
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*1, (sSizeX-(74+1)*2)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2);
			AddButtonList(35, 180, 60, 60 + 15, 14, 3);
			break;
		case 3:
			AddButton((sSizeX-74)/2, (sSizeX-74)/2+74, sSizeY-45, sSizeY-45+20, 1);
			break;
	...
	case 64:
		switch(mode) {
		case 0:
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*0, (sSizeX-(74+1)*2)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1); // search
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*1, (sSizeX-(74+1)*2)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2); // cancel
			break;
		case 1:
			AddButton((sSizeX-(74+1)*3)/2+(74+1)*0, (sSizeX-(74+1)*3)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1); // bid
			AddButton((sSizeX-(74+1)*3)/2+(74+1)*1, (sSizeX-(74+1)*3)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2); // buyout
			AddButton((sSizeX-(74+1)*3)/2+(74+1)*2, (sSizeX-(74+1)*3)/2+(74+1)*2+74, sSizeY-45, sSizeY-45+20, 3); // cancel
			break;
		case 2:
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*0, (sSizeX-(74+1)*2)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1); // sell
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*1, (sSizeX-(74+1)*2)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2); // cancel
			AddButton(20, 20+90, 96, 96+16, 3); // quantity
			AddButton(20, 20+90, 114, 114+16, 4); // minimum bid
			AddButton(20, 20+90, 132, 132+16, 5); // buyout price
			break;
		case 3:
			AddButton((sSizeX-74)/2, (sSizeX-74)/2+74, sSizeY-45, sSizeY-45+20, 1);
			break;
	...
	case 13: //////CityHall
		switch (mode) {
		case 0:
			AddButtonList(35, 220, 45, 60, 12, 1);
			/*AddButton(35, 220, 65, 80, 2);
			AddButton(35, 220, 85, 100, 3);
			AddButton(35, 220, 105, 120, 4);
			AddButton(35, 220, 125, 140, 5);
			AddButton(35, 220, 145, 160, 6);
			AddButton(35, 220, 165, 180, 7);
			AddButton(35, 220, 185, 200, 8);
			AddButton(35, 220, 205, 220, 9);
			AddButton(35, 220, 225, 240, 10);
			AddButton(35, 220, 245, 260, 11);*/
			break;
		case 1:
		...
		case 5:
			...
			break;
		case 6:
			AddButton(0, sSizeX/2, 60, 60+15, 1);
			AddButton(sSizeX/2, sSizeX, 60, 60+15, 2);
			AddButton(LBTNPOSX, LBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 3);
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 4);
			AddButton(0, sSizeX/3, 235, 235+15, 5);
			AddButton(sSizeX/3, sSizeX/2, 235, 235+15, 6);
			AddButton(sSizeX/2, sSizeX, 235, 235+15, 7);
			break;
		case 7:
			AddButtonList(35, 220, 60, 75, 9, 1, 0);
			AddButton(35, 220, 210, 230, 10);
		...
		case 9:
			...
			AddButtonList(30, 230, 73, 88, 14, 2);
			AddScrollBar(230, 255, 25, 325, 16);
			AddButton((sSizeX-74*3)/2+0*74-5, (sSizeX-74*3)/2+0*74-5+74, sSizeY-50, sSizeY-50+20, 19);
			AddButton((sSizeX-74*3)/2+1*74-5, (sSizeX-74*3)/2+1*74-5+74, sSizeY-50, sSizeY-50+20, 20);
			AddButton((sSizeX-74*3)/2+2*74-5, (sSizeX-74*3)/2+2*74-5+74, sSizeY-50, sSizeY-50+20, 21);
			AddButton((sSizeX-74*2)/2+0*74-5, (sSizeX-74*2)/2+0*74-5+74, sSizeY-30, sSizeY-30+20, 23);
			AddButton((sSizeX-74*2)/2+1*74-5, (sSizeX-74*2)/2+1*74-5+74, sSizeY-30, sSizeY-30+20, 22);
			break;
		case 10:
		...
		case 15: // legion service male/female item
			AddButtonList((sSizeX-74)/2, (sSizeX-74)/2+74, 100, 120, 3, 1, 5);
			break;
		case 16:
			AddButton(30, 30 + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 1);
			AddButton(154, 154 + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 2);
			break;
		case 17:
			AddButtonList(30, 210, 75, 90, 14, 1);
			AddScrollBar(230, 255, 25, 325, 15);
			break;
		}
		break;
	...
	case 14: ///////Bank
		...
		case 0:
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 1);
			//AddButtonList((sSizeX-74)/2, (sSizeX-74)/2+74, 50, 50+20, 5, 2, 5);
			break;
		case 1:
		case 2:
		case 3:
		case 4:
		case 5:
			AddButtonList(30, 210, 90, 105, 13, 1);
			AddScrollBar(230, 255, 25, 325, 14);
			AddButton((sSizeX-74*3)/2+0*74-5, (sSizeX-74*3)/2+0*74-5+74, sSizeY-50, sSizeY-50+20, 15);
			AddButton((sSizeX-74*3)/2+1*74-5, (sSizeX-74*3)/2+1*74-5+74, sSizeY-50, sSizeY-50+20, 16);
			AddButton((sSizeX-74*3)/2+2*74-5, (sSizeX-74*3)/2+2*74-5+74, sSizeY-50, sSizeY-50+20, 17);
			AddButton((sSizeX-74*2)/2+0*74-5, (sSizeX-74*2)/2+0*74-5+74, sSizeY-30, sSizeY-30+20, 18);
			AddButton((sSizeX-74*2)/2+1*74-5, (sSizeX-74*2)/2+1*74-5+74, sSizeY-30, sSizeY-30+20, 19);
			AddButtonList(1, 14, 17, 28, 26, 20);
			break;
		}
		break;

	case 15: ///////Skill Menu(F8)
		AddButtonList(30, 135 + 44, 35, 50, 18, 1);
		AddButtonList(210, 230, 35, 50, 18, 19);
		AddScrollBar(230, 255, 25, 325, 37);
		break;
	...
	case 16: ///////MagicShop
		...
		case 0:
			...
			AddButton(175, 290, 260, 275, 21);
			break;

		case 2:
			AddButton(-20 + 42 +31, -20 + 50 +31, 248, 260 , 1);
			AddButton(-20 + 55 +31, -20 + 68 +31, 248, 260, 2);
			AddButton(-20 + 73 +31, -20 + 93 +31, 248, 260, 3);
			AddButton(-20 + 98 +31, -20 + 113 +31, 248, 260, 4);
			AddButton(-20 + 118 +31, -20 + 129 +31, 248, 260, 5);
			AddButton(-20 + 133 +31, -20 + 150 +31, 248, 260, 6);
			AddButton(-20 + 154 +31, -20 + 177 +31, 248, 260, 7);
			AddButton(-20 + 181 +31, -20 + 210 +31, 248, 260, 8);
			AddButton(-20 + 214 +31, -20 + 230 +31, 248, 260, 9);
			AddButton(-20 + 234 +31, -20 + 245 +31, 248, 260, 10);
			break;
		}
		break;
	...
	case 23: ///////SellOrItemRepair
		...
		case 2:
			...
			AddButton(154, 154 + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 2); // Cancel
			//AddButton(110, 110+90, 53+108, 53+108+16, 3); // add charge
			break;
		}
		break;
	...
	case 30: //////IconPanel
		AddButton(316, 350, 7, 49, 1); // Crusade
		AddButton(362, 404, 7, 48, 2); // Combat Mode Toggle
		AddButton(418, 447, 10, 35, 3); // Character
		AddButton(454, 484, 10, 35, 4); // Inventory
		AddButton(490, 521, 10, 35, 5); // Magic
		AddButton(527, 558, 10, 35, 6); // Skill
		AddButton(556, 595, 10, 35, 7); // Chat
		AddButton(591, 630, 10, 35, 8); // System Menu
		AddButton(161, 144, 21, 50, 9); // Exp
		AddButton(307, 315, 7, 50, 10); // Hunger
		break;

	case 31: //////SellList
		AddButtonList(25, 250, 55, 70, 15, 1);
		AddButton(30, 30 + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 15 + 1 ); // Sell
		AddButton(154, 154 + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 15 + 2); // Cancel
		AddScrollBar(230, 255, 25, 325, 15 + 3);
		break;

	case 32: /////Party
		switch (mode) {
		case 0:
			AddButtonList(50, 200, 80, 100, 5, 1);
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 6); 
			break;
		...
		case 4:
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 1);
			AddScrollBar(230, 255, 25, 325, 2);
			AddButtonList(205, 225, 95, 110, 12, 3);
			break;
	...
	case 36: //////Commander
		...
		case 1: // Set TP
			AddButton(15, 15 + 279, 60, 60 + 260, 1);
	...
	case 51: //////CmdHallMenu
		...
		{
		case 0: // initial diag
			AddButtonList(35, 220, 70, 95, 4, 1);// TP diag
	...
	case 53: //////DKWeaponsMenu
		AddButtonList(25, 248, 50, 65, 25, 1); 
	...
	case 59:
		switch(mode) {
		case 0:
			AddButtonList(20, 170, 55, 70, 8, 1);
			AddButtonList(170, 320, 55, 70, 8, 9);
			break;
		case 1:
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*0, (sSizeX-(74+1)*2)/2+(74+1)*0+74, sSizeY-45, sSizeY-45+20, 1); // repair
			AddButton((sSizeX-(74+1)*2)/2+(74+1)*1, (sSizeX-(74+1)*2)/2+(74+1)*1+74, sSizeY-45, sSizeY-45+20, 2); // cancel
			AddButton((sSizeX-90)/2, (sSizeX-90)/2+90, 60, 60+16, 3);
			break;
		}
		break;
	...
	case 62:
		AddButton(10, 100, 30, 40, 1); // weapons
		AddButton(110, 200, 35, 40, 2); // armor
		AddButtonList(30, 210, 50, 65, 17, 3);
		AddScrollBar(230, 255, 25, 325, 20);
		break;
	...
	case DIALOG_ADDCHARGES: /////Add Charges
		switch (mode) {
		case 1:	// Upgrade Majestic, items in the window
			AddButton(LBTNPOSX, LBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 1);
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 2);
			AddButton(75, 75+12, 115, 115+12, 3);
			AddButton(90, 90+12, 115, 115+12, 4);			
			break;
		case 3: // Success
		case 4: // Not possible
			AddButton(RBTNPOSX, RBTNPOSX + BTNSZX, BTNPOSY, BTNPOSY + BTNSZY, 1);
