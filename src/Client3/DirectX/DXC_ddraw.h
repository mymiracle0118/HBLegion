...
public:	
	...
	void DrawText(LPRECT pRect, char const * const pString, COLORREF rgb, bool wordWrap = false);
	void DrawTextEx(LPRECT pRect, char const * const pString, COLORREF rgb, DWORD flags, bool wordWrap = false);
