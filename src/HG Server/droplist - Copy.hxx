...
#ifndef XSD_DROPLIST_HXX
#define XSD_DROPLIST_HXX
...
class item_t: public ::xml_schema::type
{
  ...
  void
  tempattr (const tempattr_type& y);
  ...
  void
  tempcharge (const tempcharge_type& z);
  ...
  ::xsd::cxx::tree::one< name_type > name_;
  ::xsd::cxx::tree::one< prob_type > prob_;
  ::xsd::cxx::tree::one< tempattr_type > tempattr_;
  ::xsd::cxx::tree::one< tempcharge_type > tempcharge_;
};
