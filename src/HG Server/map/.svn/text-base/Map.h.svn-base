...
public:
	...
	int GetEmptyNamingValue(char * pName, int map);
	...
	class CItem * pGetItem(short sX, short sY, short * pRemainIDnum, char * pRemainItemColor, DWORD * pRemainItemAttribute);
	...
	bool bGetMoveable(short dX, short dY, short * pDOtype = NULL, short sMoverID = NULL, class CItem * pTopItem = NULL); 
	...
	bool  m_bNamingValueUsingStatus[2000]; // 0~999
