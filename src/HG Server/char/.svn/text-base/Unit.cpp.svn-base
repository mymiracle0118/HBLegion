...
bool Unit::RemoveMagicEffect(char magicType)
{
	...
	if (IsPlayer()) g_game->SendNotifyMsg(NULL, m_handle, NOTIFY_MAGICEFFECTOFF, magicType, m_cMagicEffectStatus[magicType], NULL, NULL);
