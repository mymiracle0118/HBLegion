...
cItem::cItem()
{
	...
	TouchEffectType = TouchEffectValue1 = TouchEffectValue2 = TouchEffectValue3 = ItemSpecEffectValue1 = 0;
	ItemSpecEffectValue2 = ItemSpecEffectValue3 = ItemPosX = ItemPosY =0;
	CurLifeSpan = 0;
	ItemCount = Attribute = TempItemAttr = 0;
	ItemUniqueID = 0;
	IsItemEquipped = PutItemInBank = FALSE;
	socket1 = socket2 = socket3 = 0;
}
//==============================================================================
cItem::~cItem()
{
